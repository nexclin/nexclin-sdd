...
- [ ] T021 [P] Hook de permissões + testes unit (Vitest) — mínimo obrigatório da constituição ❌ sem `vitest.config`, sem arquivo de teste. **Mínimo obrigatório da constituição — dívida aberta.**
